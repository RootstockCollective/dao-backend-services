...
import {
  ...
  TransactionsServerResponse, BlockscoutTransactionResponseTxResult, TokenHoldersResponse
} from './types'
import {
...
import { GetEventLogsByAddressAndTopic0, GetTokenHoldersByAddress } from '../service/address/AddressService'
